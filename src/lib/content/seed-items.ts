...
export const seedMultipleChoiceItems: MultipleChoiceQuestion[] = [
  ...
  },
  {
    ...
    itemType: "multiple_choice",
    scoringRule: "dichotomous",
    stem: "A nurse assesses a newborn at 1 minute of life: HR 110, breathing irregular but crying, some flexion of extremities, grimace with stimulation, body pink with blue extremities. What is the APGAR score?",
    options: [
      { id: "a", label: "7", isCorrect: true, feedback: "HR > 100 (2) + irregular cry (1) + some flexion (1) + grimace (1) + acrocyanosis (1) = 7." },
      { id: "b", label: "5", isCorrect: false, feedback: "Underscores HR and color." },
      { id: "c", label: "9", isCorrect: false, feedback: "Overscores breathing and tone." },
    ...
    rationale: { body: "APGAR scoring (each 0–2): Appearance, Pulse, Grimace, Activity, Respiration. HR 110 = 2; irregular but crying = 1; some flexion = 1; grimace with stimulation = 1; acrocyanosis (body pink, extremities blue) = 1. Total = 7. Scored at 1 and 5 minutes.", sources: [NCSBN_RN_PLAN, { label: "AAP/ACOG — Apgar Score Joint Statement" }] },
